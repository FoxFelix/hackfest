...
public class walkTranslateScript : MonoBehaviour
{
    GameObject cam;
    ...
    void Update()
    {
        if (pv.isMine == true)
        {
            ...
            if (gasPressed || Input.GetKey(KeyCode.W))
            {

                //transform.Translate(directionTransform.forward * 0.02f);
    ...
    public void walkSideways(Vector3 myOrientation)
    {
        ...
        //transform.Translate(directionTransform.right * horizontal * 0.02f);
